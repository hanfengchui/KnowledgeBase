...
public class OrderTools {
    ...
    private final Map<String, OrderInfo> demoOrders = Map.of(
            "ORD-2026-0001",
            new OrderInfo(
                    "ORD-2026-0001",
                    "上海星河科技有限公司",
    ...
    @Tool(name = "queryOrder", description = "根据订单号查询模拟业务系统中的订单、支付、物流或退款状态")
    public OrderInfo queryOrder(
        ...
        OrderInfo result = demoOrders.getOrDefault(normalizedOrderNo, new OrderInfo(
                normalizedOrderNo,
                "未知客户",
                "未找到",
                "0.00 CNY",
                "无",
                List.of("模拟业务系统未查询到该订单号")
        ));
